...
export default function Todo({ todo, tagDB, openUpdateTodo, deleteTodo, toggleImportant }) {
  const tags = tagDB.filter(tag => todo.tags.includes(tag.id));

  return <div className={`todo ${todo.id}`} key={todo.id}>
    ...
    <div className="todoContent">
      ...
      <div className="buttons">
        <div className="updateTodo" onClick={() => openUpdateTodo(todo.id)}>
